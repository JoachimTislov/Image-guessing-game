...
* Each Group should have 5 students. Groups will be self-forming on Discord, but if you don't have a group, let us know and we'll assist. Groups smaller than 5 people should get approval from the lecturer/student assistants.
...
* Deadline for the project code and the report is **28.11.2023 by 16.00**

## Oral exam

* 100% of the grade is based on the oral exam and performance in the project.
* Oral presentation examinations is scheduled on 15. Dec 2023. More details will follow.
